package com.example.mapbox_android;
...
// Add the building layers since we know zoom levels in range
            ...
            buttonSecondLevel.setOnClickListener(view -> indoorBuildingSource.setGeoJson(loadJsonFromAsset("white_house_lvl_1.geojson")));

            Button buttonGroundLevel = findViewById(R.id.ground_level_button);
            buttonGroundLevel.setOnClickListener(view -> indoorBuildingSource.setGeoJson(loadJsonFromAsset("white_house_lvl_0.geojson")));
        });
    }
